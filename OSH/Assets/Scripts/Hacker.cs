...
public class Hacker : MonoBehaviour
{
    ...
    string[] level1Passwords = { "password", "qwerty", "admin", "football", "letmein"};
    string[] level2Passwords = { "matricula", "tec21", "mitec", "rayo", "itesm" };
    string[] level3Passwords = { "PeñaLord", "Mexico", "international", "terrorism" };
    ...
    void ShowMainMenu()
    {
        ...
        Terminal.WriteLine("");
        Terminal.WriteLine("Press 1 for the Neighbor ");
        Terminal.WriteLine("Press 2 for the Tec System");
        Terminal.WriteLine("Press 3 for the Government");
        Terminal.WriteLine("");
    ...
    private void ShowLevelReward()
    {
        ...
        {
            case 1:
                Terminal.WriteLine("Your neighbor has been hacked");
                Terminal.WriteLine(@"
...
\/_/\ \/ \ \  __\   \ \ \____  
   \ \_\  \ \_____\  \ \_____\ 
    \/_/   \/_____/   \/_____/           
                ...
                Terminal.WriteLine("Welcome to Tec`s Server");
                break;
            case 3:
                Terminal.WriteLine("Greetings...");
                Terminal.WriteLine(@"
 ...
 |_|  |_|\___/_/\_\_|\___\___/
                ");
                Terminal.WriteLine("Welcome to the Peña server");
                break;
            default:
    ...
    void RunMainMenu(string input)
    {
        ...
        {
            Terminal.WriteLine("911, What is your Emergency?");
        }
    ...
    private void WrongPassword() {
        Terminal.ClearScreen();
        Terminal.WriteLine("You have been detected!");
        Terminal.WriteLine(@"
   _____
 /     \
| () () |
